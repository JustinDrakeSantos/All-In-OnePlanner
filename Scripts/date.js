...
export function isTheSameDay(dateA, dateB) {
  const normalizedA = new Date(dateA.getFullYear(), dateA.getMonth(), dateA.getDate(), 12, 0, 0);
  const normalizedB = new Date(dateB.getFullYear(), dateB.getMonth(), dateB.getDate(), 12, 0, 0);
