...
export function initWeekCalendar(parent, selectedDate, eventStore, isSingleDay) {
    ...
    for(const weekDay of weekDays) {
        ...
        initColumns(calendarColumnsElement, weekDay, events);
    }
...
function initAllDayListItem(parent, events) {
    ...
    const calendarAllDayListElement = calendarAllDayListItemContent.querySelector("[data-week-calendar-all-day-list-item]");

    initEventList(calendarAllDayListElement, events);

    parent.appendChild(calendarAllDayListElement);
}

function initColumns(parent, weekDay, events) {
